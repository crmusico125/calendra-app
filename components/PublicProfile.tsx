  ...
  return (
    <div className="max-w-5xl mx-auto p-5">
      {user?.id === userId && (
        ...
        <div className="flex items-center gap-2 text-sm text-muted-foreground mb-4 font-bold text-gray-600">
      ...
      {/* Welcome message */}
      <div className="text-muted-foreground mb-6 max-w-sm mx-auto text-center text-gray-600">
