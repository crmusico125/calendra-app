...
import { formatTimezoneOffset } from "@/lib/formattters";
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>The timezone for your schedule</FormDescription>
              <FormMessage />
            </FormItem>
          )}
        />
        ...
        <div className="grid grid-cols-[auto_auto]">
          {DAYS_OF_WEEK_IN_ORDER.map((dayOfWeek) => (
            <Fragment key={dayOfWeek}>
              <div key={dayOfWeek} className="capitalize text-sm font-semibold">
